...
class User 
{
	...
	function __construct($user,$display,$pass,$email,$fbid)
	{
	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("ssssssi", $this->username, $this->displayname, $secure_pass, $this->clean_email, $this->fbid, $this->activation_token, $this->user_active);
				$stmt->execute();
