...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_SPECIFY_DISPLAY"			=> "Please enter your display name",
	...
	"ACCOUNT_DISPLAY_INVALID_CHARACTERS"	=> "Display name cannot include quote or backslash characters",
...
//Miscellaneous
$lang = array_merge($lang,array(
	"CAPTCHA_FAIL"				=> "Word does not match - try again",
	"CONFIRM"				=> "Confirm",
	"DENY"					=> "Deny",
	"SUCCESS"				=> "Success",
	"ERROR"					=> "Error",
